...
module pratica6_top(SW, CLOCK_50, HEX0, HEX1, HEX2, HEX3, HEX4, HEX5, HEX6, HEX7, LEDR, LEDG);
	...
	// FIOS INTERNOS
	wire [31:0] pc_valor, instrucao_valor, ULA_valor, reg1_valor, reg2_valor, imm_valor;
	wire [2:0] ula_op_valor;
	wire clock, reset, zero_flag, overflow_flag, ULA_src_valor;
	...
	processador processador_placa(
		...
		.ULAop_out(ula_op_valor),
		.ULASrc_out(ULA_src_valor)
	);
	...
	wire [31:0] hex4_data;
	assign hex4_data = (ULA_src_valor == 1'b1) ? imm_valor : reg2_valor;
