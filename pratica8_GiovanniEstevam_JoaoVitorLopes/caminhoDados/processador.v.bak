module processador(clock, reset, pcout_out, instruction_out, ULA_result_out, zero_out, overflow_out, reg1_data_out,
	...
	// INSERÇÃO DA INSTANCIAÇÃO DA MEMÓRIA DE DADOS
	
	// INSERÇÃO DO MUX DO WRITE DATA
	
	// ENQUANTO NAO INSERIMOS A MEMÓRIA DE DADOS, WRITEDATA DO BANCO DE REGISTRADORES SERÁ A SAÍDA DA ULA
