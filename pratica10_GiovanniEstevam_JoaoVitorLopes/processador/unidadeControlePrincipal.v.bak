module unidadeControlePrincipal(opcode, RegDst, Branch, MemRead, MemtoReg, ULAOp, MemWrite, ULASrc, RegWrite);
	input [5:0] opcode;
	output RegDst, Branch, MemRead, MemtoReg, MemWrite, ULASrc, RegWrite;
	output [1:0] ULAOp; 
